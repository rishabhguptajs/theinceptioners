...
export default function BookingPage() {
    ...
    const generateInvoicePDF = async () => {
        ...
        page.drawText(`Price per person: ₹${packageData?.price}`, {
            x: 50,
            y: 560,
            size: 12,
            font: helveticaFont,
        ...
        page.drawText(`Total Amount: ₹${(packageData?.price || 0) * formData.numberOfTravelers}`, {
            x: 50,
            y: 500,
            size: 16,
            font: helveticaBold,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/bookings`, {
                ...
                specialRequests: formData.specialRequests ? [formData.specialRequests] : []
            });
        ...
        <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 mb-10 transform hover:scale-[1.01] transition-all">
                    <h2 className="text-3xl font-bold text-gray-800 mb-3">{packageData.title}</h2>
                    <p className="text-gray-700 mb-6 text-lg">{packageData.description}</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-8 bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
                    <div className="space-y-6">
                        <div>
                            <label htmlFor="customerName" className="block text-lg font-semibold text-gray-700 mb-2">
                                Full Name
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="customerEmail" className="block text-lg font-semibold text-gray-700 mb-2">
                                Email Address
                            </label>
                            <input
                                type="email"
                        ...
                        <div>
                            <label htmlFor="customerPhone" className="block text-lg font-semibold text-gray-700 mb-2">
                                Phone Number
                            </label>
                            <input
                                type="tel"
                        ...
                        <div>
                            <label htmlFor="numberOfTravelers" className="block text-lg font-semibold text-gray-700 mb-2">
                                Number of Travelers
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label htmlFor="specialRequests" className="block text-lg font-semibold text-gray-700 mb-2">
                                Special Requests
                            </label>
                            <textarea
                                id="specialRequests"
                    ...
                    <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-8 rounded-xl shadow-inner">
                        <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-2">
                            Total Price: ₹{(packageData.price * formData.numberOfTravelers).toFixed(2)}
                        </p>
                    ...
                    <div className="flex gap-4">
                        <button
                            type="submit"
                            disabled={submitting}
                            className={`flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-xl text-lg font-semibold ${submitting ? 'opacity-50 cursor-not-allowed' : 'hover:from-blue-700 hover:to-purple-700'} transition-all duration-200`}
                        >
                            {submitting ? (
